...
values('a', 'analista@gmail.com', 'analista', '$2a$10$RCYXCIKCXh8iCCh3aPM2CO2T1GxaTPZT4FREKtOr6qk3slfRFKUzW', 1);

insert ignore into mydb.tb_users
(id, email, name, password, role_id)
values('b', 'revisor@gmail.com', 'revisor', '$2a$10$RCYXCIKCXh8iCCh3aPM2CO2T1GxaTPZT4FREKtOr6qk3slfRFKUzW', 2);

insert ignore into mydb.tb_users
(id, email, name, password, role_id)
values('c', 'aprovador1@gmail.com', 'aprovador1', '$2a$10$RCYXCIKCXh8iCCh3aPM2CO2T1GxaTPZT4FREKtOr6qk3slfRFKUzW', 3);

insert ignore into mydb.tb_users
(id, email, name, password, role_id)
values('d', 'aprovador2@gmail.com', 'aprovador2', '$2a$10$RCYXCIKCXh8iCCh3aPM2CO2T1GxaTPZT4FREKtOr6qk3slfRFKUzW', 3);

insert ignore into mydb.tb_users
(id, email, name, password, role_id)
values('e', 'aprovador3@gmail.com', 'aprovador3', '$2a$10$RCYXCIKCXh8iCCh3aPM2CO2T1GxaTPZT4FREKtOr6qk3slfRFKUzW', 3);
